...
`beeswax(name::ASCIIString)`  
        ...
        beeswax("buzz.bswx") runs the program buzz.bswx up to a default limit of 10 million ticks.
        Equivalent to beeswax("buzz.bswx",0,0.0,10^7).


"""
function beeswax(name::AbstractString)
    beeswax(name,0,0.0,10^7)
end
